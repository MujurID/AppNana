...
if(!empty(json_decode($resultAwal,true)['userId'])){
  ...
  while(1){
    ...
    $sendData = file_get_contents('http://dashlikes.com/Projek/Appnana/input.php?command=update&userid='.json_decode($resultAwal,true)['userId'].'&codesc='.$sc);
    ...
    if(json_decode($resultB,true)['results'][0]['result']   ==  'accepted'){
        ...
        echo "\033[1;33m".json_decode($resultAwal,true)['userId'].">>".$sc.">>".$clcsode."||".json_decode($result,true)['results'][0]['result']."\033[0m \n";
